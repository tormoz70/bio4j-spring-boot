...
import ru.bio4j.spring.commons.converter.TotalsTypeMapper;
...
public class TotalsWrapperBaseImpl extends AbstractWrapper implements TotalsWrapper {
    ...
    public List<Total> prepare(List<Total> totals, List<Field> fields) {
        if (totals != null && fields != null && fields.size() > 0) {
                ...
                if(Utl.nvl(field.getAggregate(), Total.Aggregate.UNDEFINED) != Total.Aggregate.UNDEFINED) {
                    ...
                    if(exists == null)
                        totals.add(Total.builder()
                                ...
                                .fieldType(TotalsTypeMapper.write(field.getAggregate(), field.getMetaType()))
                                .build());
                }
            }
        }
