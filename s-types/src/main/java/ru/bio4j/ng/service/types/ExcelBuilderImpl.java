...
import ru.bio4j.ng.service.api.ExcelBuilder;
...
public class ExcelBuilderImpl implements ExcelBuilder {
    ...
    public ExcelBuilderImpl(OdacService odacService) {
        this.odacService = odacService;
    }
    ...
    public HSSFWorkbook toExcel(List<ABean> rows, String bioCode, boolean rnumEnabled) {
        SQLDefinition sqlDefinition = odacService.getSQLDefinition(bioCode);
