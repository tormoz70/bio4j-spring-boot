 ...
 *
 * @version $Id: BeanHandler.java 5631 2012-05-10 08:31:33Z teck $
 * @author Adam Murdoch
 * @author Greg Luck
 */
final class MyBeanHandler extends DefaultHandler {

    private static final Logger LOG = LoggerFactory.getLogger(MyBeanHandler.class.getName());
    private final Object bean;
    private MyBeanHandler.ElementInfo element;
     ...
     * Constructor.
     */
    public MyBeanHandler(final Object bean) {
        this.bean = bean;
    }
    ...
    public void startElement(final String uri,
        ...
        if (extractingSubtree() || startExtractingSubtree(getTagPart(qName))) {
            ...
            element = new MyBeanHandler.ElementInfo(element, qName, bean);
        } else {
            if (element == null) {
                element = new MyBeanHandler.ElementInfo(qName, bean);
            } else {
                final Object child = createChild(element, qName);
                element = new MyBeanHandler.ElementInfo(element, qName, child);
            }
     ...
     */
    private Object createChild(final MyBeanHandler.ElementInfo parent, final String name)
            throws SAXException {
        ...
        try {
            ...
            if (method != null) {
                return method.invoke(parent.bean);
            }
    ...
    private static Object createInstance(Object parent, Class<?> childClass)
        ...
        final Constructor<?> constructor = candidates.remove(0);
     ...
     * Sets an attribute.
     */
    private void setAttribute(final MyBeanHandler.ElementInfo element,
    ...
    private void endSubtree() throws SAXException {
        try {
            ...
            subtreeMethod.invoke(element.parent.bean, subtreeText.toString());
    ...
    private static final class ElementInfo {
        private final MyBeanHandler.ElementInfo parent;
        ...
        public ElementInfo(final MyBeanHandler.ElementInfo parent, final String elementName, final Object bean) {
            this.parent = parent;
            this.elementName = elementName;
            this.bean = bean;
        }
